...
GlobalConfig::$CONNECTION_SETTING->DBName = "canis_database";
...
/** the root url of the application with trailing slash, for example http://localhost/gerenciador do banco de dados - canis/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'TCC2019/dba/';
