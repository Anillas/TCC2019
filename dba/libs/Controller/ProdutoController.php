...
class ProdutoController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Id,Nome,Tipo,Descricao,Preco,Quantidade,Imagem'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			$produto->Tipo = $this->SafeGetVal($json, 'tipo');
			$produto->Descricao = $this->SafeGetVal($json, 'descricao');
			$produto->Preco = $this->SafeGetVal($json, 'preco');
			$produto->Quantidade = $this->SafeGetVal($json, 'quantidade');
			$produto->Imagem = $this->SafeGetVal($json, 'imagem');
	...
	public function Update()
	{
		try
		{
			...
			$produto->Tipo = $this->SafeGetVal($json, 'tipo', $produto->Tipo);
			$produto->Descricao = $this->SafeGetVal($json, 'descricao', $produto->Descricao);
			$produto->Preco = $this->SafeGetVal($json, 'preco', $produto->Preco);
			$produto->Quantidade = $this->SafeGetVal($json, 'quantidade', $produto->Quantidade);
			$produto->Imagem = $this->SafeGetVal($json, 'imagem', $produto->Imagem);
